<template>
  ...
  >
    ...
    <div
        ...
        style="opacity:var(--opacity-closed, 0%);transform:translateX(var(--x-closed, -100%))"
    >
      ...
      >
        <div class="px-[5%]">
          <h1 class="text-4xl mb-5 font-bold md:mb-6">
            Deine Momente. Für immer fühlbar.
          </h1>
          <p class="text-md">
            ...
            wiedererleben kannst. Unsere Produkte lassen deine Erlebnisse lebendig
            werden.
          </p>
    ...
    <div class="container">
      <div class="flex flex-col items-center">
        <div class="mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          <p class="mb-3 font-semibold md:mb-4 text-[var(--primary-color)]">Das ist der MemoryTag</p>
        ...
        >
          ...
          <div class="flex w-full flex-col items-center text-center">
            ...
            <p>
              Das digitale Album hinter dem MemoryTag ist in Sekunden eingerichtet
              und kann jederzeit mit digitalen Inhalten befüllt werden
            </p>
          </div>
          <div class="flex w-full flex-col items-center text-center">
            <div class="mb-5 md:mb-6">
  ...
  <section class="px-[5%] py-16 md:py-24 lg:py-28">
    <div class="container">
      <div class="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
        <p class="mb-3 font-semibold md:mb-4 text-[var(--primary-color)]">Funktionsweise</p>
        <h1 class="text-3xl mb-5 font-bold md:mb-6">
          Wie funktioniert der MemoryTag?
        </h1>
        <p class="text-md">
          Drei einfache Schritte, um deine Lieblingsmomente über den MemoryTag
      ...
      <div class="grid auto-cols-fr grid-cols-1 gap-6 md:gap-8 lg:grid-cols-3">
        <div
            data-slot="card"
            class="overflow-hidden rounded-card border border-neutral-950 bg-scheme-foreground text-scheme-text flex flex-col"
        >
          <div
          ...
          <div class="flex flex-1 flex-col justify-center p-6 md:p-8">
            <div>
              <p class="mb-2 font-semibold">Schritt 1</p>
              <h2 class="text-xl mb-3 font-bold md:mb-4">
                Den MemoryTag an ein beliebiges Objekt anbringen
              </h2>
              <p>
        ...
        >
          ...
          <div class="flex flex-1 flex-col justify-center p-6 md:p-8">
            <div>
              ...
              <p>
                ... über das Adminportal, welches nur du mit einem Passwort öffnen
                kannst. Hier kannst du Bilder (und in Zukunft weitere Inhalte)
                hochladen.
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div class="flex flex-1 flex-col justify-center p-6 md:p-8">
            <div>
              <p class="mb-2 font-semibold">Schritt 3</p>
              <h2 class="text-xl mb-3 font-bold md:mb-4">
    ...
    <div class="container">
      <div class="flex flex-col items-center">
        <div class="mb-12 w-full max-w-lg text-center md:mb-18">
          <p class="mb-3 font-semibold md:mb-4 text-[var(--primary-color)]">Anwendungsbeispiele</p>
          <h2 class="text-3xl mb-5 font-bold md:mb-6">
            Wo kann ich den MemoryTag einsetzen?
          </h2>
          <p class="text-md">Die Frage ist eher: Wo nicht?</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="sticky top-0">
      ...
      <div
          class="bg-white md:pb-14 sticky pb-0 top-0 mb-32"
      >
        <div class="px-[5%]">
          <div class="container">
            ...
            <div class="py-8 md:py-10 lg:py-12">
              ...
              >
                <div>
                  ...
                  <p class="text-md">
                    Auf einer Reise werden viele Momente erlebt - eine Fotoleinwand (oder ein eingerahmtes Bild) zeigt nur einen davon.
                    Eine kulinarische Besonderheit? Das komische (aber irgendwie süße) Selfie mit einer fremden Person? Mit MemoryTag kannst du (oder deine Gäste) all diese Momente wiedererleben - und zwar an dem Ort, an den sie gehören.
                  </p>
                </div>
                <div class="relative">
                  <img
                      src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image-1.svg"
                      class="h-[25rem] w-full rounded-image object-cover sm:h-[30rem] lg:h-[60vh]"
                      alt="Relume placeholder image 1"
                  />
                </div>
              </div>
      ...
      <div class="relative -top-32 h-0"></div>
      <div
          class="border-t border-neutral-950 bg-white md:pb-14 sticky pb-0 top-16 -mt-16 mb-16"
      >
        <div class="px-[5%]">
          <div class="container">
            <a href="#" class="flex h-16 w-full items-center underline"
            ...
            <div class="py-8 md:py-10 lg:py-12">
              ...
              >
                <div>
                  <p class="mb-3 font-semibold md:mb-4">Besondere Lebensabschnitte</p>
                  <h2 class="text-3xl mb-5 font-bold md:mb-6">
                    Dein Hausbau?
                    Ein Moment zum nicht-vergessen!
                  </h2>
                  <p class="text-md">
                    Stell dir vor: Du baust ein Haus und in 10 Jahren kannst du deinen Kindern davon nur noch erzählen, weil du blöderweise alle Fotos in der Cloud verloren hast - oder nicht mehr weißt, wo du sie gespeichert hast.
                    Nicht mit uns! Bringe den MemoryTag irgendwo im Haus an - z.B. deiner Haustüre - und halte dein Smartphone dran.
                  </p>
                </div>
                <div class="relative">
                  <img
      ...
      <div class="relative -top-32 h-0"></div>
      <div
          class="border-t border-neutral-950 bg-white md:pb-14 sticky pb-0 top-36 -mt-36 mb-16"
      >
        <div class="px-[5%]">
          <div class="container">
            <a href="#" class="flex h-16 w-full items-center underline"
            ...
            <div class="py-8 md:py-10 lg:py-12">
              ...
              >
                <div>
                  ...
                  <p class="text-md">
                    Das erste Krabbeln, die ersten Schritte oder einfach nur ein Schnappschuss des süßestens Lächeln. Alles Momente, die es wert sind, auch in Jahrzenten noch wiedererlebt zu werden.
                    Befestige den MemoryTag an dem Lieblingskuscheltier deiner Tochter und hebe dieses auf - und du hast automatisch deine digitalen Erinnerungen dabei.
                  </p>
                </div>
                <div class="relative">
                  <img
  ...
  <section class="px-[5%] py-16 md:py-24 lg:py-28">
    <div class="container">
      <div class="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
        <p class="mb-3 font-semibold md:mb-4 text-[var(--primary-color)]">Wer sind wir?</p>
        <h2 class="text-3xl mb-5 font-bold md:mb-6">
      ...
      >
        ...
        <div class="flex flex-col text-center">
          ...
          <div class="mb-3 md:mb-4">
            <h5 class="text-large font-semibold">Nicole Harsch</h5>
            <h6 class="text-md">Gründerin, Marketing, Werbung</h6>
          </div>
          <div
              class="mt-6 grid grid-flow-col grid-cols-[max-content] gap-3.5 self-center"
          >
        ...
        <div class="flex flex-col text-center">
          ...
          <div class="mb-3 md:mb-4">
            <h5 class="text-large font-semibold">Johannes Harsch</h5>
            <h6 class="text-md">Gründer, Shop, Finanzen</h6>
          </div>
          <div
              class="mt-6 grid grid-flow-col grid-cols-[max-content] gap-3.5 self-center"
          >
      ...
      >
        ...
        <div>
          <p class="text-md text-white">
            ...
            den ersten gehören, die den MemoryTag ihr Eigen nennen? Tragt euch in
            unsere Warteliste ein und werdet informiert, sobald es den MemoryTag
            zu kaufen gibt.
          </p>
          <div class="mt-6 flex flex-wrap gap-4 md:mt-8">
            <button
  ...
  <footer class="px-[5%] py-12 md:py-18 lg:py-20">
    <div class="container">
      ...
      <div
          class="text-sm flex flex-col items-start justify-start pt-6 pb-4 md:flex-row md:items-center md:justify-between md:pt-8 md:pb-0 md:text-center gap-6"
      >
        <ul
            class="text-sm grid grid-flow-row grid-cols-[max-content] gap-y-4 md:grid-flow-col md:gap-x-6 md:gap-y-0 lg:justify-center"
        >
          <li class="underline"><NuxtLink to="impressum">Impressum</NuxtLink></li>
        </ul>
        <p>© 2025 LHC Momentify. All rights reserved.</p>
      </div>
    </div>
  </footer>
...
<style>
:root {
  --primary-color: #0771b3;
  --secondary-color: #34495e;
  --background-color: #ffffff;
  --surface-color: #ffffff;
  --background-color-darker: #dcdcdc;
  --text-color: #2c3e50;
  --text-color-inverted: #e3f1ff;
  --border-color: #cdcdcd;
  ...
  --logo-pill-background: rgba(255, 255, 255, 0.4);
  --logo-pill-box-shadow: inset 0 0px 8px 3px rgba(220, 220, 220, 0.3);
  --navigation-container-box-shadow: 0px 15px 15px 1px rgb(0 0 0 / 30%);
}

[data-theme="dark"] {
  --primary-color: #0b8bdc;
  ...
  --border-color: #5c5c5c;
  --icon-filter: brightness(0) saturate(100%) invert(96%) sepia(38%)
  saturate(0%) hue-rotate(298deg) brightness(108%) contrast(101%);
  --skeleton-gradient: linear-gradient(
      90deg,
      #555555 0%,
      #2c2c2c 50%,
  ...
  --logo-pill-background: rgba(0, 0, 0, 0.2);
